...
def main():
  ...
  num_trainable_params = sum(tf.size(v).numpy() for v in model.trainable_variables)
  num_non_trainable_params = sum(tf.size(v).numpy() for v in model.non_trainable_variables)

  print(f"Trainable parameters: {num_trainable_params}")
  print(f"Non-trainable parameters: {num_non_trainable_params}")
  print(f"Total parameters: {num_trainable_params + num_non_trainable_params}")
