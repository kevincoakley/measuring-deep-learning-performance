...
from utils.kc_tools import NoEarlyStopping
...
class Exp_Main(Exp_Basic):
    ...
    def train(self, setting):
        ...
        if self.args.no_early_stopping:
            save_every_epoch_path = "./epochs/" + str(self.args.data) + "/" + str(self.args.pred_len) + "/"
            early_stopping = NoEarlyStopping(save_every_epoch=self.args.save_every_epoch, save_every_epoch_path=save_every_epoch_path, seed=self.args.seed, verbose=True)
        else:
    ...
    def test(self, setting, test_model_path=None, test=0):
        test_data, test_loader = self._get_data(flag='test')
        if test:
            print('loading model')
